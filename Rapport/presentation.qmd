...
ajouter première réunion, mettre des majuscules
...
# Project's mind map
corriger carte mentale
extreme value
maxima
modelisation of maxima
modelisation on excess data
prediction à la place d'interpolation
détail des maps dans la bulle
<div style="display: flex; flex-direction: column; justify-content: center; align-items: center; height: 100%;">
  <figure style="text-align: center;">
