...
# Tools
 ...
 - Ressources needed whe ncoding
 - Research obaut Extrem Value Theory
 - Where do we find data-sets

 <div style="position: absolute; top: 10px; right: 50px;"> <img src="images/tools.png" alt="meteo" style="width: 800px;"> </div>
